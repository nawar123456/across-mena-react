const translations = {
    title: {
        ...
        seapage:'شحن بحري',
        subtitlesea:'تغطية شاملة وحلول مبتكرة تلبي احتياجات العملاء بتنوع واختلاف شحناتهم مع أهم خطوط النقل الجوي الموثوقة في العالم',
        landpage:'شحن بري',
        ...
        subtitlcustomsclearance:'حلول تخليص جمركي مبتكرة مصمّمة لتسريع عملياتك التجارية، حيث نضمن تنفيذ كافة الإجراءات الجمركية مع الالتزام الكامل بالشروط والإجراءات المحلية والدولية.',
    ...
    labelHomePage:{
		...
		labelheaderTrackShipment:'تتبع الشحنات',
		text1TrackShipment:'احصل على موقع شحنتك في كل لحظة وتعرّف على التقديرات الدقيقة لمواعيد وصولها، مما يوفر لك رؤية شاملة تساعدك على التخطيط بشكل أفضل لإدارة عملياتك بفعالية وتجنب أي تأخيرات غير متوقعة، مما يجعل عملية الشحن أكثر أمانًا وكفاءة.',
		text2TrackShipment:'',

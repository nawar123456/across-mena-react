...
import  styles from './InputPhoneServices.module.css'
...
const InputPhoneServices = ({styleColor,field,getInputText,value,placeholder,title ,Icon,errorValue,valid}) => {
    ...
    return (
      <div className={styles['input-box-services']}>

        <span style={styleColor} className={`${styles['input-label-services']} ${ isFocused || value ? styles['active'] : ''}`} >
            {title}
        </span>
...
<span className={styles['input-icon-services']}>{Icon}</span>
...
{isValid && (
 ...
 {/* Conditional checkmark icon */}
  ...
  export default InputPhoneServices;

...
import './TimeLineAddBook.css';
import { useState,useEffect } from 'react';

const TimeLineAddBook = ({Pos,variant,startDate,
  cityFrom,cityTo,portTitleTo,portTitleFrom, endDate,
...
<span className={
    ...
    <div className={`timeline-type ${variant}`}>
        ...
        <span className={`type-title ${variant} `} style={{color:visible?'#000':'#727272',opacity:visible?'1':'0.7'}}>
...
export default TimeLineAddBook
